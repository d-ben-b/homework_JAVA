...
int main(int argc, char *argv[])
{
    ...
    readfile_bridge();
    bridge_block();
    if(1 == bridge_strategy())
    {
        printf("BRIDGE@@@@@@\n");
    }
    else if(1 == chess_strategy())
    {
        printf("CHESS@@@@@@\n");
    }
    else
...
void write_bridge(int i,int j)/**寫入橋的數值*/
{
    int a,b;
    int max = 0;
    int count = 0;
            ...
            if(chess_and_bridge[i][j] == team + '0')/**找島*/
            {
                        ...
                        bridge_board[i - 1][j - 1] == 0)
                {
                    ...
                    return 1;
                        ...
                        chess_and_bridge[i + 2][j + 2] == 'B' ) &&
                        bridge_board[i + 1][j + 1] == 0)/**type3*/
                {
...
void bridge_island()/**找出已經放過的島嶼*/
{
    ...
    for(x = 0; x < 4; x++)
    {
        for(i = 0;i < 10; i++)
        {
            for(j = 0; j < 10; j++)
            {
                if((chess_and_bridge[i][j] == 'L' || chess_and_bridge[i][j] == 'B') && chess_board[i][j] == team)
                {
    ...
    for(i = 0; i < 10; i++)
    {
        for(j = 0; j < 10; j++)
        {
            if(chess_and_bridge[i][j] == 'B')
            {
                ...
                else if(chess_and_bridge[i + 1][j + 1] == '0' &&
                        chess_and_bridge[i + 2][j + 2] == 'B' &&
                        i + 2 < 10 &&
                        j + 2 < 10 &&
                        bridge_board[i + 1][j + 1] == 0)
